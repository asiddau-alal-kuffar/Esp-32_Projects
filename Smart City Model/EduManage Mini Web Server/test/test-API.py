...
def send_message(phone_number, instance_id,access_token, message):
  ...
  url = "https://demo.betablaster.in/api/send?number="+phone_number+"&type=text&message="+message+"&instance_id="+instance_id+"&access_token="+access_token
...
#  "https://demo.betablaster.in/api/send?number="+phone_number+"&type=text&message="+message+"&instance_id="+instance_id+"&access_token="+access_token